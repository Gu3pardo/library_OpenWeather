...
public class StringHelper {
    public static int GetStringCount(@NonNull String stringToTest, @NonNull String charToFind) {
        int lastIndex = 0;
        int count = 0;
        while (lastIndex != -1) {
    ...
    public static int[] GetCharPositions(@NonNull String stringToTest, char charToFind) {
    ...
    public static String SelectString(@NonNull String[] stringArray, @NonNull String stringToFound) {
        int stringCount = stringArray.length;
        for (int index = 1; index < stringCount; index++) {
