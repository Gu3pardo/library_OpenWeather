...
public enum WeatherCondition implements Serializable {
    ...
    Squalls(10, "squalls", R.drawable.weather_wallpaper_squalls, R.drawable.weather_squalls,
            ...
            0),
    Sun(11, "sun", R.drawable.weather_wallpaper_sun, R.drawable.weather_clear /*TODO*/,
    ...
    public String GetWeekendTipTomorrow() {
        return _weekendTip.replace("Today", "Tomorrow").replace("today", "tomorrow").replace("It's", "Tomorrow is");
    }
    ...
    public String GetWorkdayTipTomorrow() {
        return _workdayTip.replace("Today", "Tomorrow").replace("today", "tomorrow").replace("It's", "Tomorrow is");
    }
    ...
    public String GetWorkdayAfterWorkTipTomorrow() {
        return _workdayAfterWorkTip.replace("Today", "Tomorrow").replace("today", "tomorrow").replace("It's", "Tomorrow is");
    }
