...
public enum WeatherCondition implements Serializable {
    ...
    Clear(1,
            "clear",
            R.drawable.weather_wallpaper_clear,
    ...
    Cloud(2,
            "cloud",
            R.drawable.weather_wallpaper_cloud,
    ...
    Drizzle(3,
            "drizzle",
            R.drawable.weather_wallpaper_drizzle,
    ...
    Fog(4,
            "fog",
            R.drawable.weather_wallpaper_fog,
    ...
    Haze(5,
            "haze",
            R.drawable.weather_wallpaper_haze,
    ...
    Mist(6,
            "mist",
            R.drawable.weather_wallpaper_mist,
    ...
    Rain(7,
            "rain",
            R.drawable.weather_wallpaper_rain,
    ...
    Sleet(8,
            "sleet",
            R.drawable.weather_wallpaper_sleet,
    ...
    Snow(9,
            "snow",
            R.drawable.weather_wallpaper_snow,
    ...
    Squalls(10,
            "squalls",
            R.drawable.weather_wallpaper_squalls,
            R.drawable.weather_squalls,
    ...
    Sun(11,
            "sun",
            R.drawable.weather_wallpaper_sun,
            R.drawable.weather_sun,
            "Enjoy the sunny weather today and chill!",
            "Today will be sunny! Get out for lunch!",
            "Enjoy your time after work today! Will be sunny!",
            0),
    Thunderstorm(12,
            "thunderstorm",
            R.drawable.weather_wallpaper_thunderstorm,
    ...
    public String GetWeekendTipTomorrow() {
        String weekendTomorrowTip = _weekendTip;
        return weekendTomorrowTip
                .replace("Today", "Tomorrow")
                .replace("today", "tomorrow")
                .replace("It's", "Tomorrow is");
    }
    ...
    public String GetWorkdayTipTomorrow() {
        String workdayTomorrowTip = _workdayTip;
        return workdayTomorrowTip
                .replace("Today", "Tomorrow")
                .replace("today", "tomorrow")
                .replace("It's", "Tomorrow is");
    }
    ...
    public String GetWorkdayAfterWorkTipTomorrow() {
        String workdayAfterWorkTomorrowTip = _workdayAfterWorkTip;
        return workdayAfterWorkTomorrowTip
                .replace("Today", "Tomorrow")
                .replace("today", "tomorrow")
                .replace("It's", "Tomorrow is");
    }
