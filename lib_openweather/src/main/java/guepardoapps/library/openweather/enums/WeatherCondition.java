...
public enum WeatherCondition implements Serializable {
    ...
    NULL(0, "null", R.drawable.wallpaper_dummy, R.drawable.weather_dummy, "", "", "", 0),
    CLEAR(1, "clear", R.drawable.wallpaper_clear, R.drawable.weather_clear,
